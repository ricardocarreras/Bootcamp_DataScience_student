...
url = "https://raw.githubusercontent.com/marcusRB/IDbootcamps_DataScience_student_PT_10201/master/dataset/bank_budget_data.csv"
s = requests.get(url, verify=False).content
bank_pd = pd.read_csv(io.StringIO(s.decode('utf-8')))
print(bank_pd.head(1))
